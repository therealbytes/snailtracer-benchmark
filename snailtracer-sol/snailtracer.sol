...
contract SnailTracer {
    ...
    function Init() public {
        ...
        spheres.push(
            Sphere(
                100000000000,
                Vector(100001000000, 40800000, 81600000),
                Vector(0, 0, 0),
                Vector(750000, 250000, 250000),
                Material.Diffuse
            )
        );
        spheres.push(
            Sphere(
                100000000000,
                Vector(-99901000000, 40800000, 81600000),
                Vector(0, 0, 0),
                Vector(250000, 250000, 750000),
                Material.Diffuse
            )
        );
        spheres.push(
            Sphere(
                100000000000,
                Vector(50000000, 40800000, 100000000000),
                Vector(0, 0, 0),
                Vector(750000, 750000, 750000),
                Material.Diffuse
            )
        );
        spheres.push(
            Sphere(
                100000000000,
                Vector(50000000, 40800000, -99830000000),
                Vector(0, 0, 0),
                Vector(0, 0, 0),
                Material.Diffuse
            )
        ...
        spheres.push(
            Sphere(
                100000000000,
                Vector(50000000, 100000000000, 81600000),
                Vector(0, 0, 0),
                Vector(750000, 750000, 750000),
                Material.Diffuse
            )
        ...
        spheres.push(
            Sphere(
                100000000000,
                Vector(50000000, -99918400000, 81600000),
                Vector(0, 0, 0),
                Vector(750000, 750000, 750000),
                Material.Diffuse
            )
        ...
        spheres.push(
            Sphere(
                16500000,
                Vector(27000000, 16500000, 47000000),
                Vector(0, 0, 0),
                Vector(999000, 999000, 999000),
                Material.Specular
            )
        );
        spheres.push(
            Sphere(
                600000000,
                Vector(50000000, 681330000, 81600000),
                Vector(12000000, 12000000, 12000000),
                Vector(0, 0, 0),
                Material.Diffuse
            )
        );
        ...
        triangles.push(
            Triangle(
                Vector(56500000, 25740000, 78000000),
                Vector(73000000, 25740000, 94500000),
                Vector(73000000, 49500000, 78000000),
                Vector(0, 0, 0),
                Vector(0, 0, 0),
                Vector(999000, 999000, 999000),
                Material.Specular
        ...
        triangles.push(
            Triangle(
                Vector(56500000, 23760000, 78000000),
                Vector(73000000, 0, 78000000),
                Vector(73000000, 23760000, 94500000),
                Vector(0, 0, 0),
                Vector(0, 0, 0),
                Vector(999000, 999000, 999000),
                Material.Specular
        ...
        triangles.push(
            Triangle(
                Vector(89500000, 25740000, 78000000),
                Vector(73000000, 49500000, 78000000),
                Vector(73000000, 25740000, 94500000),
                Vector(0, 0, 0),
                Vector(0, 0, 0),
        ...
        triangles.push(
            Triangle(
                Vector(89500000, 23760000, 78000000),
                Vector(73000000, 23760000, 94500000),
                Vector(73000000, 0, 78000000),
                Vector(0, 0, 0),
                Vector(0, 0, 0),
        ...
        triangles.push(
            Triangle(
                Vector(56500000, 25740000, 78000000),
                Vector(73000000, 49500000, 78000000),
                Vector(73000000, 25740000, 61500000),
                Vector(0, 0, 0),
                Vector(0, 0, 0),
                Vector(999000, 999000, 999000),
                Material.Specular
        ...
        triangles.push(
            Triangle(
                Vector(56500000, 23760000, 78000000),
                Vector(73000000, 23760000, 61500000),
                Vector(73000000, 0, 78000000),
                Vector(0, 0, 0),
                Vector(0, 0, 0),
                Vector(999000, 999000, 999000),
        ...
        for (uint i = 0; i < triangles.length; i++) {
            ...
            triangles[i].normal = norm(
                cross(sub(tri.b, tri.a), sub(tri.c, tri.a))
            );
        }
    }
    ...
    function TraceScanline(int y, int spp) public returns (bytes memory) {
        for (int x = 0; x < width; x++) {
            ...
            buffer.push(intToByte(color.x));
            buffer.push(intToByte(color.y));
            buffer.push(intToByte(color.z));
        }
        return buffer;
    }
    ...
    function trace(
        ...
        for (int k = 0; k < spp; k++) {
            ...
            Ray memory ray = Ray(
                add(camera.origin, mul(pixel, 140)),
                norm(pixel),
                0,
                false
            );
    ...
    function clamp(int x) internal pure returns (int) {
        if (x < 0) {
            return 0;
        }
        if (x > 1000000) {
    ...
    function sin(int x) internal pure returns (int y) {
    ...
    function add(
        Vector memory u,
        Vector memory v
    ) internal pure returns (Vector memory) {
    ...
    function mul(Vector memory v, int m) internal pure returns (Vector memory) {
    ...
    function div(Vector memory v, int d) internal pure returns (Vector memory) {
        return Vector(v.x / d, v.y / d, v.z / d);
    }

    function dot(Vector memory u, Vector memory v) internal pure returns (int) {
    ...
    function radiance(
        ...
        Vector memory _intersect = add(
            ray.origin,
            div(mul(ray.direction, dist), 1000000)
        );
        Vector memory normal = norm(sub(_intersect, obj.position));
        ...
        if (obj.reflection == Material.Diffuse) {
            ...
            return diffuse(ray, _intersect, normal);
        } else {
            // For specular reflectivity
            return specular(ray, _intersect, normal);
        }
    }
    ...
    function radiance(
        ...
        int cos2t = 1000000000000 -
            (nnt * nnt * (1000000000000 - ddn * ddn)) /
            1000000000000;
        if (cos2t < 0) {
            return specular(ray, _intersect, obj.normal);
        }
        return refractive(ray, _intersect, obj.normal, nnt, ddn, cos2t);
    }

    function diffuse(
        Ray memory ray,
        Vector memory _intersect,
        ...
        u = norm(
            add(
                add(
                    mul(u, (cos(r1) * r2s) / 1000000),
                    mul(v, (sin(r1) * r2s) / 1000000)
                ),
    ...
    function specular(
        ...
        Vector memory reflection = norm(
            sub(
                ray.direction,
                mul(normal, (2 * dot(normal, ray.direction)) / 1000000)
            )
        );
        return radiance(Ray(_intersect, reflection, ray.depth, ray.refract));
    }
    ...
    function refractive(
        ...
        Vector memory refraction = norm(
            div(
                sub(
                    mul(ray.direction, nnt),
                    mul(normal, sign * ((ddn * nnt) / 1000000 + sqrt(cos2t)))
                ),
                1000000
            )
        );
        ...
        int re = 40000 +
            ((1000000 - 40000) * c * c * c * c * c) /
            1000000000000000000000000000000;

        // Split a direct hit, otherwise trace only one ray
        if (ray.depth <= 2) {
            refraction = mul(
                radiance(Ray(_intersect, refraction, ray.depth, !ray.refract)),
                1000000 - re
            ); // Reuse refraction variable (lame)
            refraction = add(
                refraction,
        ...
        return
            div(
                mul(
                    radiance(
                        Ray(_intersect, refraction, ray.depth, !ray.refract)
                    ),
                    1000000 - re
                ),
                750000 - re / 2
